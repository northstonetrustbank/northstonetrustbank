...
export const de: Dict = {
  ...
  about: {
    ...
    body:
      "Northstone Trust Bank ist eine moderne Bank, gebaut auf einem alten Gedanken: Geld ist etwas Persönliches, und die Entscheidungen darüber verdienen menschliches Urteilsvermögen statt eines automatischen Ja oder Nein.",
    storyTitle: "Warum wir Northstone gegründet haben",
    storyBody1:
  ...
  securityPage: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Hat das Geld Northstone verlassen, kontaktieren wir die empfangende Bank und fordern den Rückruf der Zahlung. Schnelles Handeln verbessert die Aussichten erheblich.",
      },
      {
    ...
    urgentSteps: [
      ...
      "Schreiben Sie an support@northstonetrustbank.com oder öffnen Sie den Live-Chat auf unserer Startseite.",
    ],
    protectTitle: "So schützen Sie sich",
    protect: [
      {
        title: "Wir fragen nie nach Ihrem Passwort",
        body: "Niemand von Northstone fragt nach Ihrem Passwort oder Sicherheitswort — weder per E-Mail noch am Telefon noch im Chat. Wer das tut, sind nicht wir.",
      },
      {
        title: "Prüfen Sie die Adresse, nicht den Namen",
        body: "Unsere E-Mails kommen von northstonetrustbank.com. Ein Anzeigename lässt sich leicht fälschen, die Domain hinter dem @ nicht.",
      },
      {
  ...
  contactPage: {
    ...
    channels: [
      {
        ...
        body: "Fragen zu Northstone, zur Kontoeröffnung oder zu allem anderen.",
        value: "info@northstonetrustbank.com",
      },
      {
        title: "Bestandskunden",
        body: "Hilfe zu Ihrem Konto, einer Einzahlung, einer Auszahlung oder einer Karte.",
        value: "support@northstonetrustbank.com",
      },
      {
        title: "Kundenbetreuung",
        body: "Kredite, Baufinanzierungen und Firmenkundenbeziehungen.",
        value: "accountmanager@northstonetrustbank.com",
      },
    ],
    ...
    locationBody: "Northstone Trust Bank · New York, Vereinigte Staaten.",
    ...
    errorFailed: "Das Senden hat nicht geklappt. Schreiben Sie uns direkt an support@northstonetrustbank.com.",
  },
  faqPage: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            q: "Kann ich Geld an ein anderes Northstone-Konto senden?",
  ...
  legal: {
    ...
    draftNotice:
      "Dies ist ein aktueller Entwurf und kann aktualisiert werden. Bei Fragen kontaktieren Sie support@northstonetrustbank.com.",
    back: "Zurück zur Startseite",
  },
  nav: {
    personal: "Privatkunden",
    commercial: "Firmenkunden",
    why: "Warum Northstone",
    contact: "Kontakt",
    about: "Über uns",
    faq: "FAQ",
  ...
  landing: {
    ...
    personal: {
      ...
      items: [
        ...
        { title: "Autokredit", body: "Finanzieren Sie das passende Fahrzeug \u2013 zum \u00fcber die gesamte Laufzeit festen Zins." },
        { title: "Studienkredit", body: "Finanzieren Sie Studium oder Ausbildung; die R\u00fcckzahlung beginnt, wenn Sie beginnen." },
        { title: "Modernisierungskredit", body: "Nehmen Sie Kapital auf Ihre eigene Immobilie auf und steigern Sie ihren Wert." },
        { title: "Immobiliendarlehen", body: "Nutzen Sie den in Ihrer Immobilie aufgebauten Wert f\u00fcr gr\u00f6\u00dfere Vorhaben." },
    ...
    pillars: [
      ...
      },
      {
        ...
        body: "Erreichen Sie unser Team direkt unter support@northstonetrustbank.com — jede Nachricht wird von einem Menschen gelesen und beantwortet.",
      },
    ],
    ...
    benefitsKicker: "Warum Northstone",
    ...
    fast: [
      ...
      { title: "Überweisungen", body: "Sofort an einen anderen Northstone-Kunden senden — jederzeit." },
    ],
  ...
  auth: {
    ...
    resetPanelTitle: "Zurück zu Ihren Konten.",
    resetPanelBody: "Setzen Sie Ihr Passwort zurück und Sie sind nur einen Moment von Ihrem Dashboard, Ihren Anträgen und Auszügen entfernt.",
    choosePanelTitle: "Ein Neuanfang.",
    choosePanelBody: "Wählen Sie ein neues Passwort und machen Sie dort weiter, wo Sie aufgehört haben.",
    loginPanelTitle: "Willkommen zurück.",
    loginPanelBody: "Ihre Konten, Anträge und Auszüge — alles an einem Ort.",
    signingIn: "Anmeldung…",
    newTo: "Neu bei Northstone?",
  },
  onboarding: {
  ...
  dashboard: {
    ...
    inProgressBody: "Wartet auf unser Team. Tippen Sie darauf, um den Stand zu sehen.",
    ...
    hideBalance: "Kontostand ausblenden",
    showBalance: "Kontostand anzeigen",
    needHelp: "Brauchen Sie Hilfe?",
    liveChat: "Live-Chat",
    liveChatBody: "Sofortige Hilfe von unserem Team",
    emailChoose: "Wen möchten Sie anschreiben?",
    emailSupportTeam: "Support-Team",
    emailManager: "Ihr Kundenbetreuer",
    emailSubject: "Northstone — Supportanfrage",
    emailSupport: "E-Mail-Support",
    emailSupportBody: "Senden Sie uns eine ausführliche Nachricht",
    support247: "24/7-Support",
    support247Body: "Wir sind jederzeit für Sie da",
    achievements: "Erfolge",
    firstDeposit: "Erste Einzahlung",
    firstDepositBody: "Ein guter Start in Ihre finanzielle Reise.",
    accountHealth: "Kontozustand",
    healthy: "Gesund",
    watch: "Ausgaben im Blick",
    keptRatio: "Behalten im Zeitraum",
    income: "Einnahmen",
    expenses: "Ausgaben",
    tip: "Tipp",
    tipTitle: "Regelmäßig sparen",
    tipBody: "Richten Sie automatische Überweisungen ein, um Rücklagen aufzubauen.",
    insights: "Auswertung",
    sendAgain: "Erneut senden",
    beneficiaries: "Bereits bezahlte Personen und Unternehmen",
    addNew: "Hinzufügen",
    net: "Netto",
    last90: "Letzte 90 Tage",
    noBeneficiaries: "Noch niemand gespeichert",
  ...
  cardsPage: {
    title: "Karten",
    subtitle: "Ihre Northstone-Karten, ihre Limits und ihre Einstellungen",
    empty: "Sie haben noch keine Karte",
    emptyBody:
      "Beantragen Sie eine Northstone-Karte — sie erscheint hier, sobald unser Team Ihren Antrag geprüft hat.",
  ...
  loansPage: {
    ...
    calculatorLede: "Verschieben Sie die Laufzeit und sehen Sie, wie Rate und Gesamtzinsen gegeneinander laufen.",
    calculatorProduct: "Kredit",
    calculatorAmount: "Betrag",
    calculatorRate: "Zins (% effektiv)",
    calculatorTerm: "Über",
    calculatorMonths: "Monate",
    calculatorMonthly: "Pro Monat",
    calculatorTotalInterest: "Zinsen",
    calculatorTotalPayable: "Gesamt zurückgezahlt",
    calculatorOutOfRange: "Geben Sie Betrag und Laufzeit innerhalb des Rahmens dieses Produkts ein, um die Zahlen zu sehen.",
    rateLabel: "Ab",
    amountLabel: "Bis zu",
    termLabel: "Laufzeit",
    available: "Wofür Sie sich bewerben können",
    availableLede: "Feste Zinsen, klare Konditionen, von einem Menschen entschieden.",
  ...
  txn: {
    progressTitle: "Verlauf",
    stepSubmitted: "Eingereicht",
    stepReview: "Von unserem Team geprüft",
    stepDeclined: "Von unserem Team abgelehnt",
    stepCredited: "Ihrem Konto gutgeschrieben",
    stepSent: "Gesendet",
    receiptTitle: "Das liegt jetzt bei uns",
    receiptBody: "Behalten Sie diese Seite — sie ist Ihr Beleg. Wir schreiben Ihnen, sobald sich etwas tut.",
    ...
    pendingNote: "Unser Team prüft das während der Geschäftszeiten von Hand. Sie erhalten eine E-Mail, sobald es erledigt ist, und diese Seite wird ebenfalls aktualisiert.",
  ...
  accountsPage: {
    title: "Konten",
    subtitle: "Alle Konten, die Sie bei Northstone führen",
  ...
  products: {
    ...
    balanceLabel: "Saldo",
    yourName: "Ihr Name",
    sampleCard: "Dies ist eine Beispielkarte. Beantragen Sie Ihre eigene Northstone-Karte.",
    samplePreview: "Vorschau — dieses Produkt ist noch nicht aktiv.",
    yourProducts: "Ihre Produkte",
    productsSubtitle: "Alles, was Sie bei Northstone haben — und alles, was Sie eröffnen können.",
    ...
    fields: {
      vehicleMake: "Marke und Modell",
      vehicleYear: "Baujahr",
      vehiclePrice: "Kaufpreis des Fahrzeugs",
      vehicleCondition: "Zustand",
      institutionName: "Schule, Hochschule oder Universit\u00e4t",
      courseOfStudy: "Studienfach",
      courseYears: "Dauer der Ausbildung in Jahren",
      studyLevel: "Abschlussart",
      worksDescription: "Welche Arbeiten planen Sie?",
      outstandingMortgage: "Restschuld Ihrer Immobilienfinanzierung",
      ...
      loanPurpose: "Wofür ist der Kredit?",
    ...
    fieldOptions: {
      ...
      POSTGRADUATE: "Master oder Promotion",
    ...
    amountRange: "{min} bis {max}",
    termRange: "{min}–{max} Monate",
    ratesNote: "Die gezeigten Zinsen sind unsere niedrigsten und hängen von Ihren Verhältnissen ab. Ihr endgültiger Zins und Rahmen werden nach der Prüfung bestätigt.",
  ...
  statements: {
    ...
    footer:
      "Dieser Auszug wird aus dem Buchungsjournal Ihres Northstone-Kontos erstellt. Bei Unstimmigkeiten wenden Sie sich innerhalb von 60 Tagen an support@northstonetrustbank.com.",
  },
  docs: {
  ...
  send: {
    title: "Geld senden",
    body: "Sofort an ein anderes Northstone-Konto senden. Für eine externe Bank nutzen Sie die Option Auszahlen.",
    recipient: "Empfänger",
    recipientHint: "Geben Sie die Northstone-Kontonummer oder E-Mail des Empfängers ein.",
    submit: "Senden",
    submitting: "Wird gesendet…",
    recipientRequired: "Geben Sie einen Empfänger ein.",
    selfError: "Sie können kein Geld an Ihr eigenes Konto senden.",
    externalUseWithdraw: "Das ist kein Northstone-Konto. Für eine externe Bank nutzen Sie die Option Auszahlen.",
  },
  services: {
    title: "Finanzdienste",
    subtitle: "Zuschüsse, Steuererstattungen und mehr — hier beantragen und verfolgen.",
    viewAll: "Alle ansehen",
    loansTitle: "Kredite",
    loansNote: "Privat, Auto, Studium, Hypothek und mehr.",
    grantsTitle: "Zuschüsse",
    grantsNote: "Förderung ohne Rückzahlung, für Berechtigte.",
    taxTitle: "Steuererstattungen",
    taxNote: "Erstattung beantragen und bis auf Ihr Konto verfolgen.",
    cardsTitle: "Karten",
    amountNote: "Betrag: {amount}",
    cardNote: "Karte endet auf {last4}",
    cardsNote: "Ihre Northstone-Karten und deren Einstellungen.",
    ...
    available: "Verfügbar",
    active: "Aktiv",
    grantsHeading: "Zuschüsse & finanzielle Hilfen",
    grantsLede: "Förderung, die ein Ziel ohne Rückzahlung unterstützt. Sagen Sie uns, wofür — unser Team prüft jede Anfrage.",
    grantProgram: "Förderprogramm",
    grantProgramHint: "Die Art der Unterstützung, die Sie beantragen.",
    programBusiness: "Kleinunternehmen",
    programEducation: "Bildung",
    programHome: "Wohneigentum",
    programEmergency: "Nothilfe",
    programCommunity: "Gemeinwesenentwicklung",
    programHealth: "Gesundheit",
    amountPlaceholder: "10.000",
    grantEmployment: "Beschäftigungsstatus",
    grantIncome: "Jährliches Haushaltseinkommen",
    grantDependents: "Anzahl der Angehörigen",
    emEmployed: "Angestellt",
    emSelf: "Selbstständig",
    emUnemployed: "Derzeit ohne Arbeit",
    emRetired: "Rentner",
    emStudent: "Student",
    incUnder15: "Unter 15.000 $",
    inc15to30: "15.000 – 30.000 $",
    inc30to60: "30.000 – 60.000 $",
    inc60to100: "60.000 – 100.000 $",
    incOver100: "Über 100.000 $",
    amountRequested: "Beantragter Betrag",
    reason: "Wofür ist es?",
    reasonHint: "Ein paar Zeilen dazu, wie die Förderung verwendet würde.",
    applyGrant: "Zuschussantrag senden",
    taxHowTitle: "Für Sie eingereicht",
    taxHowLede: "Ihr Kundenbetreuer übernimmt die Einreichung.",
    taxStep1: "Stellen Sie unten Ihre Anfrage — nennen Sie das Steuerjahr und alles Relevante.",
    taxStep2: "Ihr Kundenbetreuer meldet sich und bestätigt Ihre Identität sicher über ID.me.",
    taxStep3: "Er reicht Ihre Erstattung ein, die auf Ihr Northstone-Konto ausgezahlt wird.",
    taxRequestTitle: "Einreichung anfragen",
    taxRequestLede: "Wir melden uns, in der Regel innerhalb von 1–2 Werktagen.",
    taxNoteLabel: "Sollen wir etwas wissen? (optional)",
    taxNoteHint: "Frühere Erklärungen, erwartete Erstattung oder Fragen an Ihren Betreuer.",
    taxRequestSubmit: "Einreichung anfragen",
    taxHeading: "Steuererstattung",
    taxLede: "Beantragen Sie eine Erstattung auf Ihr Northstone-Konto. Die Identität wird über die sichere Anmeldung von ID.me bestätigt — wir fragen hier nie nach Ihrem ID.me-Passwort.",
    taxYear: "Steuerjahr",
    filingStatus: "Veranlagungsart",
    filingSingle: "Einzelveranlagung",
    filingJoint: "Zusammenveranlagung",
    filingSeparate: "Getrennte Veranlagung",
    filingHead: "Haushaltsvorstand",
    expectedRefund: "Erwartete Erstattung",
    idmeTitle: "Identitätsprüfung",
    idmeVerify: "Mit ID.me verifizieren",
    idmePending: "Die Verifizierung wird sicher mit Ihrem Kundenbetreuer abgeschlossen. Sie geben Ihr ID.me-Passwort nie auf dieser Seite ein.",
    idmeBody: "Nach dem Absenden bestätigen Sie Ihre Identität auf der sicheren Website von ID.me. Ihre ID.me-Anmeldung wird nie auf dieser Seite eingegeben.",
    applyTax: "Erstattungsantrag senden",
    reviewNote: "Anträge werden von unserem Team geprüft, in der Regel innerhalb von 5–7 Werktagen.",
    alreadyApplied: "Sie haben bereits eine offene Anfrage dazu. Wir melden uns.",
    programRequired: "Wählen Sie ein Förderprogramm.",
    reasonRequired: "Sagen Sie uns, wofür die Förderung ist.",
  ...
  setup2fa: {
    ...
    subtitle: "Northstone verlangt die Zwei-Faktor-Prüfung. Aktivieren Sie sie jetzt, um fortzufahren.",
    point1: "Bei jeder Anmeldung wird Ihnen ein Einmalcode per E-Mail gesendet.",
    point2: "Ihr Passwort allein öffnet Ihr Konto nicht mehr.",
    point3: "Es dauert Sekunden und lässt sich später unter Sicherheit verwalten.",
    enable: "Aktivieren & fortfahren",
    enabling: "Wird aktiviert…",
    notYou: "Nicht Sie?",
  },
  payments: {
    title: "Rechnungen & Empf\u00e4nger",
    lede: "Speichern Sie die Personen und Unternehmen, die Sie bezahlen, und begleichen Sie eine Rechnung mit drei Tipps \u2013 statt jeden Monat Kontodaten neu einzugeben.",
    tabPay: "Bezahlen",
    tabPayees: "Empf\u00e4nger",
    tabHistory: "Verlauf",

    payTitle: "Rechnung bezahlen",
    choosePayee: "Wen bezahlen Sie?",
    noPayeesTitle: "Noch keine Empf\u00e4nger gespeichert",
    noPayeesBody: "Legen Sie die Unternehmen und Personen an, die Sie regelm\u00e4\u00dfig bezahlen \u2013 die Daten werden einmal gespeichert und jedes Mal wiederverwendet.",
    addFirstPayee: "Ersten Empf\u00e4nger anlegen",
    amount: "Betrag",
    memo: "Verwendungszweck",
    memoHint: "Ihre Kunden- oder Rechnungsnummer dort. Wird dem Empf\u00e4nger \u00fcbermittelt, sofern die Zahlungsart dies unterst\u00fctzt.",
    payFrom: "Bezahlen von",
    submitPay: "Bezahlen",
    submittingPay: "Zahlung wird gesendet\u2026",
    instantNote: "Dieser Empf\u00e4nger ist Northstone-Kunde \u2013 die Zahlung kommt sofort an.",
    reviewNote: "Zahlungen an externe Konten werden gepr\u00fcft, bevor sie die Bank verlassen.",
    arrives: "\u00dcbliche Dauer",

    payeesTitle: "Gespeicherte Empf\u00e4nger",
    addPayee: "Empf\u00e4nger anlegen",
    editPayee: "Empf\u00e4nger bearbeiten",
    payeeName: "Name des Empf\u00e4ngers",
    payeeNameHint: "Der Name auf der Rechnung \u2013 der Stromversorger, die Vermieterin, die Person.",
    nickname: "Ihre Bezeichnung",
    nicknameHint: "Optional. Wie Sie es nennen, z.\u2009B. \u201eStrom Wohnung\u201c.",
    kind: "Art des Empf\u00e4ngers",
    kindBiller: "Ein Unternehmen oder eine Rechnung",
    kindPerson: "Eine Person",
    kindInternal: "Ein anderer Northstone-Kunde",
    method: "Zahlungsweg",
    accountRef: "Kontonummer oder Kennung",
    accountRefInternal: "Northstone-Kontonummer oder E-Mail-Adresse",
    institution: "Bank oder Anbieter",
    institutionHint: "Optional. Wo das Empf\u00e4ngerkonto gef\u00fchrt wird.",
    save: "Empf\u00e4nger speichern",
    saving: "Wird gespeichert\u2026",
    saved: "Empf\u00e4nger gespeichert.",
    remove: "Entfernen",
    removeConfirm: "Diesen Empf\u00e4nger entfernen? Ihr Zahlungsverlauf bleibt erhalten.",
    lastPaid: "Zuletzt bezahlt",
    neverPaid: "Noch nicht bezahlt",
    cancel: "Abbrechen",
    payThis: "Bezahlen",

    historyTitle: "Zahlungsverlauf",
    noHistoryTitle: "Noch keine Zahlungen",
    noHistoryBody: "Bezahlte Rechnungen erscheinen hier mit Referenz und Status.",

    nameRequired: "Geben Sie den Namen des Empf\u00e4ngers ein.",
    accountRefRequired: "Geben Sie die Kontonummer oder Kennung ein.",
    internalNotFound: "Zu dieser Nummer oder E-Mail-Adresse geh\u00f6rt kein aktives Northstone-Konto.",
    internalSelf: "Das ist Ihr eigenes Konto.",
    methodUnavailable: "Dieser Zahlungsweg ist derzeit nicht verf\u00fcgbar. Bitte w\u00e4hlen Sie einen anderen.",
    payeeNotFound: "Diesen Empf\u00e4nger gibt es nicht mehr.",
    notReady: "Empf\u00e4nger sind noch nicht verf\u00fcgbar. Bitte versuchen Sie es gleich erneut.",
  },
  goals: {
  ...
  support: {
    ...
    safetyBody:
      "Niemand von Northstone fragt nach Ihrem Passwort, Ihrem Sicherheitswort oder einem Anmeldecode — weder hier noch per E-Mail oder Telefon.",
  ...
  errors: {
    ...
    blocked:
      "Dieses Konto ist derzeit eingeschränkt. Bitte kontaktieren Sie support@northstonetrustbank.com.",
    rejected:
      "Dieser Antrag wurde nicht genehmigt. Kontaktieren Sie support@northstonetrustbank.com für Einzelheiten.",
    ...
    uploadFailed: "Wir konnten Ihre Dateien gerade nicht speichern, es wurde daher nichts geändert. Bitte versuchen Sie es gleich noch einmal — wenn das Problem bestehen bleibt, schreiben Sie an support@northstonetrustbank.com.",
  },
};
