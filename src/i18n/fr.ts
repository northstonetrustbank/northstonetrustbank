...
export const fr: Dict = {
  ...
  about: {
    ...
    body:
      "Northstone Trust Bank est une banque moderne bâtie sur une idée ancienne : l'argent est une affaire personnelle, et les décisions qui l'entourent méritent un jugement humain plutôt qu'un oui ou un non automatique.",
    storyTitle: "Pourquoi nous avons créé Northstone",
    storyBody1:
  ...
  securityPage: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Lorsque les fonds ont quitté Northstone, nous contactons l'établissement destinataire et demandons le rappel du paiement. Agir vite améliore nettement les chances de récupération.",
      },
      {
    ...
    urgentSteps: [
      ...
      "Écrivez à support@northstonetrustbank.com ou ouvrez le chat sur notre page d'accueil.",
    ],
    protectTitle: "Comment vous protéger",
    protect: [
      {
        title: "Nous ne demandons jamais votre mot de passe",
        body: "Personne chez Northstone ne vous demandera votre mot de passe ni votre mot de sécurité — ni par e-mail, ni par téléphone, ni par chat. Si on vous le demande, ce n'est pas nous.",
      },
      {
        title: "Vérifiez l'adresse, pas le nom",
        body: "Nos e-mails proviennent de northstonetrustbank.com. Un nom d'expéditeur est facile à falsifier ; le domaine après le @ ne l'est pas.",
      },
      {
  ...
  contactPage: {
    ...
    channels: [
      {
        ...
        body: "Questions sur Northstone, l'ouverture d'un compte, ou tout autre sujet.",
    ...
    locationBody: "Northstone Trust Bank · New York, États-Unis.",
    ...
    errorFailed: "L'envoi a échoué. Écrivez-nous directement à support@northstonetrustbank.com.",
  },
  faqPage: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            q: "Puis-je envoyer de l'argent à un autre compte Northstone ?",
  ...
  legal: {
    ...
    draftNotice:
      "Ceci est une version provisoire susceptible d'être mise à jour. Pour toute question, contactez support@northstonetrustbank.com.",
    back: "Retour à l'accueil",
  },
  nav: {
    personal: "Particuliers",
    commercial: "Entreprises",
    why: "Pourquoi Northstone",
    contact: "Contact",
    about: "À propos",
    faq: "FAQ",
  ...
  landing: {
    ...
    pillars: [
      ...
      },
      {
        ...
        body: "Contactez notre équipe à support@northstonetrustbank.com — une personne lit et répond à chaque message.",
      },
    ],
    ...
    benefitsKicker: "Pourquoi Northstone",
    ...
    fast: [
      ...
      { title: "Virements", body: "Envoyez vers un autre client Northstone instantanément — à tout moment." },
    ],
  ...
  dashboard: {
    ...
    emailChoose: "À qui souhaitez-vous écrire ?",
    emailSupportTeam: "Équipe d'assistance",
    emailManager: "Votre conseiller",
    emailSubject: "Northstone — demande d'assistance",
  ...
  cardsPage: {
    title: "Cartes",
    subtitle: "Vos cartes Northstone, leurs plafonds et leurs réglages",
    empty: "Vous n'avez pas encore de carte",
    emptyBody:
      "Demandez une carte Northstone : elle apparaîtra ici dès que notre équipe aura examiné votre dossier.",
  ...
  loansPage: {
    ...
    availableLede: "Taux fixes, conditions claires, décidés par une personne.",
  ...
  tickets: {
    ...
    teamName: "Assistance Northstone",
  ...
  accountsPage: {
    title: "Comptes",
    subtitle: "Tous les comptes que vous détenez chez Northstone",
  ...
  products: {
    ...
    balanceLabel: "Solde",
    yourName: "Votre nom",
    sampleCard: "Ceci est une carte d'exemple. Faites une demande pour obtenir votre carte Northstone.",
    samplePreview: "Aperçu — ce produit n'est pas encore actif.",
    yourProducts: "Vos produits",
    productsSubtitle: "Tout ce que vous détenez chez Northstone, et tout ce que vous pouvez ouvrir.",
    ...
    fields: {
      ...
      loanPurpose: "À quoi sert le prêt ?",
    ...
    fieldOptions: {
      ...
      MAJOR_PURCHASE: "Un achat important",
      HOME_IMPROVEMENT: "Travaux",
      DEBT_CONSOLIDATION: "Regroupement de dettes",
      NEW: "Neuf",
      USED: "D\u2019occasion",
    ...
    amountTooHigh: "C'est supérieur au maximum de ce produit ({max}). Réduisez le montant ou renseignez-vous sur un financement plus important.",
  ...
  statements: {
    ...
    footer:
      "Ce relevé est généré à partir du registre de votre compte Northstone. En cas d'erreur, contactez support@northstonetrustbank.com sous 60 jours.",
  },
  docs: {
  ...
  send: {
    title: "Envoyer de l'argent",
    body: "Envoyez instantanément vers un autre compte Northstone. Pour une banque externe, utilisez l'option Retirer.",
    recipient: "Destinataire",
    recipientHint: "Saisissez le numéro de compte Northstone ou l'e-mail du destinataire.",
    submit: "Envoyer",
    submitting: "Envoi…",
    recipientRequired: "Saisissez un destinataire.",
    selfError: "Vous ne pouvez pas envoyer de l'argent à votre propre compte.",
    externalUseWithdraw: "Ce n'est pas un compte Northstone. Pour envoyer vers une banque externe, utilisez l'option Retirer.",
  },
  services: {
    ...
    cardsNote: "Vos cartes Northstone et leurs réglages.",
    ...
    grantEmployment: "Situation professionnelle",
    grantIncome: "Revenu annuel du foyer",
    grantDependents: "Nombre de personnes à charge",
    emEmployed: "Salarié",
    emSelf: "Indépendant",
    emUnemployed: "Sans emploi",
    emRetired: "Retraité",
    emStudent: "Étudiant",
    incUnder15: "Moins de 15 000 $",
    inc15to30: "15 000 – 30 000 $",
    inc30to60: "30 000 – 60 000 $",
    inc60to100: "60 000 – 100 000 $",
    incOver100: "Plus de 100 000 $",
    ...
    taxHowTitle: "Déclaré pour vous",
    taxHowLede: "Votre conseiller s'occupe de la déclaration.",
    taxStep1: "Faites votre demande ci-dessous — indiquez l'année fiscale et tout élément utile.",
    taxStep2: "Votre conseiller vous contacte et vérifie votre identité en toute sécurité via ID.me.",
    taxStep3: "Il déclare votre remboursement, versé sur votre compte Northstone.",
    taxRequestTitle: "Demander la déclaration",
    taxRequestLede: "Nous vous recontacterons, généralement sous 1 à 2 jours ouvrés.",
    taxNoteLabel: "Un détail à signaler ? (facultatif)",
    taxNoteHint: "Déclarations antérieures, remboursement attendu ou questions pour votre conseiller.",
    taxRequestSubmit: "Demander la déclaration",
    taxHeading: "Remboursement d'impôts",
    taxLede: "Demandez un remboursement versé sur votre compte Northstone. L'identité est confirmée via la connexion sécurisée d'ID.me — nous ne demandons jamais votre mot de passe ID.me ici.",
    ...
    idmeVerify: "Vérifier avec ID.me",
    idmePending: "La vérification sera effectuée en toute sécurité avec votre conseiller. Vous ne saisirez jamais votre mot de passe ID.me sur cette page.",
  ...
  setup2fa: {
    ...
    subtitle: "Northstone exige la vérification en deux étapes. Activez-la pour accéder à votre tableau de bord.",
    point1: "Un code à usage unique vous est envoyé par e-mail à chaque connexion.",
    point2: "Votre mot de passe seul ne peut plus ouvrir votre compte.",
    point3: "Cela prend quelques secondes ; vous pourrez la gérer dans Sécurité.",
    enable: "Activer et continuer",
    enabling: "Activation…",
  ...
  payments: {
    ...
    instantNote: "Ce b\u00e9n\u00e9ficiaire est client Northstone\u2009: le paiement arrive imm\u00e9diatement.",
    ...
    kindInternal: "Un autre client Northstone",
    method: "Mode de paiement",
    accountRef: "Num\u00e9ro de compte ou identifiant",
    accountRefInternal: "Son num\u00e9ro de compte Northstone ou son e-mail",
    ...
    internalNotFound: "Aucun compte Northstone actif ne correspond \u00e0 ce num\u00e9ro ou \u00e0 cet e-mail.",
  ...
  support: {
    ...
    safetyBody:
      "Personne chez Northstone ne vous demandera votre mot de passe, votre mot de sécurité ou un code de connexion — ni ici, ni par e-mail, ni par téléphone.",
  ...
  errors: {
    ...
    blocked:
      "Ce compte est actuellement restreint. Veuillez contacter support@northstonetrustbank.com.",
    rejected:
      "Cette demande n'a pas été approuvée. Contactez support@northstonetrustbank.com pour plus de détails.",
    ...
    uploadFailed: "Nous n'avons pas pu enregistrer vos fichiers pour le moment, rien n'a donc été modifié. Réessayez dans un instant — si le problème persiste, écrivez à support@northstonetrustbank.com.",
  },
};
